...
const addFeedback = (req, res) => {
    ...
    const sql = "INSERT INTO rj_login_feedback (ans_1, ans_2, ans_3, ans_4, ans_5,did,sid, ans_6, user_id ) VALUES (?,?,?, ?, ?, ?, ?, ?,?)";
    const data = [ans_1, ans_2, ans_3, ans_4, ans_5, did, sid, ans_6, id];
